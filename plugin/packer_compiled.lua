...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    ...
    loaded = true,
    path = "/home/pikachu/.local/share/nvim/site/pack/packer/start/nvim-treesitter",
  ...
  ["toggleterm.nvim"] = {
    config = { "\27LJ\1\2/\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0\20plugins.termboi\frequire\0" },
    loaded = true,
